...
export function getRegularDay(minutesNow) {
    ...
    else if (minutesNow >= Constants.regSecondEnd &&
        minutesNow < Constants.regThirdStart) {
        period.innerHTML = "Passing Period";
        return (classEnds = Constants.regThirdStart);
    }
    else if (minutesNow >= Constants.regThirdStart &&
    ...
    else if (minutesNow >= Constants.regThirdEnd &&
        minutesNow < Constants.regLunchStart) {
        period.innerHTML = "Passing Period";
        return (classEnds = Constants.regLunchStart);
    }
    else if (minutesNow >= Constants.regLunchStart &&
    ...
    else if (minutesNow >= Constants.regLunchEnd &&
        minutesNow < Constants.regFourthStart) {
        period.innerHTML = "Passing Period";
        return (classEnds = Constants.regFourthStart);
    }
    else if (minutesNow >= Constants.regFourthStart &&
    ...
    else if (minutesNow >= Constants.regFourthEnd &&
        minutesNow < Constants.regFifthStart) {
        period.innerHTML = "Passing Period";
        return (classEnds = Constants.regFifthStart);
    }
    else if (minutesNow >= Constants.regFifthStart &&
    ...
    else if (minutesNow >= Constants.regFifthEnd &&
        minutesNow < Constants.regSixthStart) {
        period.innerHTML = "Passing Period";
        return (classEnds = Constants.regSixthStart);
    }
    else if (minutesNow >= Constants.regSixthStart &&
    ...
    else if (minutesNow >= Constants.regSixthEnd &&
        minutesNow < Constants.regSeventhStart) {
        period.innerHTML = "Passing Period";
        return (classEnds = Constants.regSeventhStart);
    }
    else if (minutesNow >= Constants.regSeventhStart &&
